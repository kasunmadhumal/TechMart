...
<div class="col-md-4 col-md-offset-4" id="wrapper" style="margin-top:0px;width:1510px;height: 736px; margin-left:0;" >
    <div id="page-content-wrapper">
        <form class="form loginform" method="get" action="AdminLoginController" style="margin-top:150px;width:500px;height:500px;margin-left:500px;" >
            <div class="login-panel panel panel-default">
                <div class="panel-heading">Please Sign in (Admin)</div>

...
public class SalesAgentLoginValidation {
    ...
    public SalesAgentLoginValidation(String username,String password){
    ...
    public int checkLoginValidation(){
        ...
        try{
            ...
            String sql = "SELECT * FROM salesagent WHERE userID=? AND password=?";

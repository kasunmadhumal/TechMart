        ...
        <div class="row itemContainer">
          ...
          <div class="itemContent col-md-6 col-sm-6 col-lg-6">
            <h6 class="ietemDescription" style="color: green;">
              <% out.print(cartItemData.get(i).getMainCategory()+"<br>"+cartItemData.get(i).getSubCategory()+"<br>"+cartItemData.get(i).getItemName()); %>
            </h6><br>
        ...
        <table cellpadding="5px">
          <tr>
            ...
            <th style="text-align: right">
               <% for(int i =0;i<cartItemData.size();i++){out.print(cartItemData.get(i).getItemName() + "| ");}  %>
            </th>
          </tr>
        </table>
      </div>
